...
# MAGIC %md
# MAGIC Khi CDF được bật, các dư liệu CDF sẽ được ghi vào một thư mục con trong thư mục của bảng Delta, có tên `_change_data/`
...
# MAGIC %md
# MAGIC Thư mục này chứa các file parquet dữ liệu của bảng `table_changes`
